...
# def plot_embedding_2D(data, label, title, datasetName='pamap2', color_map=['r', 'y', 'k', 'g', 'b', 'm']):
...
#         tsne_2D = TSNE(n_components=2, init='pca', random_state=1)
